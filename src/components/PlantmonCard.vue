...
<template>
  <div class="plantmon-card bg-white rounded-xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
    <!-- 植宠图片 -->
    <div class="relative aspect-square bg-gradient-to-br from-purple-100 via-blue-100 to-green-100 rounded-lg mb-3 overflow-hidden">
      <img 
        :src="plantmon.image" 
        :alt="plantmon.name"
