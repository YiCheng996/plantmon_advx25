      ...
      <div class="bg-white rounded-lg p-6 mb-6 shadow-lg">
        ...
        <div class="mb-6">
          ...
          <div class="space-y-2">
            ...
            <div class="p-2 border-l-4 border-green-500">
              ...
              <div style="font-family: system-ui" class="text-xl">植物宠物大冒险 - 欢迎来到奇幻世界</div>
            </div>
            <div class="p-2 border-l-4 border-purple-500">
              <span class="text-sm text-gray-500">微软雅黑:</span>
              <div style="font-family: 'Microsoft YaHei'" class="text-xl">植物宠物大冒险 - 欢迎来到奇幻世界</div>
            </div>
          </div>
        </div>
        ...
        <div class="mb-6">
          ...
          <div class="space-y-2">
            ...
            <div class="p-2 border-l-4 border-green-500">
              <span class="text-sm text-gray-500">系统默认:</span>
              <div style="font-family: system-ui" class="text-xl">Plantmon Adventure - Welcome to Fantasy World</div>
            </div>
            <div class="p-2 border-l-4 border-purple-500">
              <span class="text-sm text-gray-500">Arial:</span>
              <div style="font-family: Arial" class="text-xl">Plantmon Adventure - Welcome to Fantasy World</div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="space-y-2">
            <div class="p-2 border-l-4 border-blue-500">
              ...
              <div class="font-mixed text-xl">Plantmon 植宠大冒险 Level 等级: 25 HP 生命值: 1500</div>
            </div>
            <div class="p-2 border-l-4 border-green-500">
              <span class="text-sm text-gray-500">系统默认:</span>
              <div style="font-family: system-ui" class="text-xl">Plantmon 植宠大冒险 Level 等级: 25 HP 生命值: 1500</div>
            </div>
          </div>
        </div>
      </div>
...
const checkFonts = async () => {
  try {
    ...
    if (document.fonts) {
      ...
      // 检查Roboto
      try {
        const robotoFont = new FontFace('Roboto', 'url(https://fonts.googleapis.com/css2?family=Roboto:wght@400&display=swap)')
