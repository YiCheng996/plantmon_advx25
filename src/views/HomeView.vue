    ...
    <div class="relative z-10 flex flex-col h-screen">
      ...
      <header class="pt-12 pb-6 text-center">
        <div class="bg-black/20 backdrop-blur-sm rounded-2xl mx-6 py-4">
          <h1 class="text-4xl font-bold text-white mb-2 drop-shadow-lg">🌱 Plantmon</h1>
        </div>
      </header>

      <!-- 植宠展示区（核心区域） -->
      <div class="flex-1 flex items-center justify-center px-6">
        <div class="plantmon-display bg-white/95 backdrop-blur-md rounded-3xl p-6 w-full max-w-sm shadow-2xl border border-white/20">
          <!-- 状态一：无植宠 -->
          <div v-if="!activePlantmon" class="text-center py-8">
            <div class="w-24 h-24 bg-gradient-to-br from-gray-200 to-gray-300 rounded-full flex items-center justify-center mx-auto mb-4 shadow-inner">
              <span class="text-4xl">🥚</span>
            </div>
            <h2 class="text-xl font-bold text-gray-700 mb-2">等待孵化中...</h2>
            <p class="text-sm text-gray-500 leading-relaxed">快去捕获你的第一只植宠吧！<br/>每一次拍照都可能遇到奇迹</p>
          </div>
          ...
          <div v-else class="text-center py-4">
            ...
            <div class="relative w-32 h-32 mx-auto mb-4">
              <div class="w-full h-full bg-gradient-to-br from-purple-100 via-blue-100 to-green-100 rounded-full overflow-hidden shadow-lg">
                <img 
              ...
              <!-- 出战光环效果 -->
              <div class="absolute -inset-1 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full animate-pulse opacity-75"></div>
            </div>
            
            <!-- 植宠信息 -->
            <h2 class="text-2xl font-bold text-gray-800 mb-1">{{ activePlantmon.name }}</h2>
            <p class="text-sm text-gray-500 mb-3 font-mono">{{ activePlantmon.id }}</p>
            ...
            <!-- 简短描述 -->
            <p class="text-xs text-gray-600 leading-relaxed px-2">{{ activePlantmon.description.slice(0, 50) }}...</p>
        ...
        <div class="bg-black/20 backdrop-blur-sm rounded-3xl p-4">
          <div class="grid grid-cols-3 gap-4">
            ...
            >
              ...
              <div class="text-xs opacity-80">发现新伙伴</div>
            </RouterLink>
            ...
            >
              <div class="text-3xl mb-2">📚</div>
              <div class="text-sm font-bold">植宠图鉴</div>
            </RouterLink>
            ...
            <a 
              :href="battleUrl" 
              target="_blank"
              class="nav-button bg-gradient-to-br from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white"
            >
              <div class="text-3xl mb-2">⚔️</div>
              <div class="text-sm font-bold">竞技对战</div>
            </a>
          </div>
        </div>
      </div>
