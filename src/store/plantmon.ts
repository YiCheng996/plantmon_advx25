      ...
      const mockPlantmons: Plantmon[] = [
        {
          ...
          description:
            '拥有神秘力量的守护者，能够保护队友免受伤害。传说中它来自远古的神殿，是光明与正义的象征。',
          isActive: false,
          rarity: 'SSSR',
        },
        {
          ...
          description:
            '栖息在深林中的精灵，与大自然和谐共生。它能感知植物的声音，是森林的忠实守护者。',
          isActive: false,
          rarity: 'SSR',
        },
        {
          ...
          description:
            '行走在黑暗中的神秘存在，动作敏捷如风。它掌握着暗影的力量，是夜晚最危险的猎手。',
          isActive: false,
          rarity: 'SR',
        },
        {
          ...
          description:
            '身披烈焰的勇敢战士，永不退缩。它的剑刃上燃烧着永恒的火焰，是战场上最耀眼的存在。',
          isActive: false,
          rarity: 'R',
        },
        {
          ...
          description:
            '掌握冰霜魔法的智者，冷静而理智。它能够操控寒冰的力量，将敌人冻结在永恒的冰晶中。',
          isActive: false,
          rarity: 'SSR',
        },
      ]
